...
export default class ShoesStore extends Component {
    ...
    prodClick = (prodClick) => {
        this.setState({
            content: {
                name: prodClick.name,
                price: prodClick.price,
                description: prodClick.description,
                image: prodClick.image
            }
        })
    }
  ...
  render() {
    return (
      <div className='container'>
        <h3 className='text-center p-3' style={{fontWeight: 'bold'}}>Shoes Shop</h3>
        <ProductList prodClick={this.prodClick} arrProd={arrShoes}/>
        <Modal content={this.state.content}/>
      </div>
    )
  }
}
